        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                _this2.reset(); // emitは親コンポーネントに値を送る
...
vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_6___default().use(vue_router__WEBPACK_IMPORTED_MODULE_7__["default"]); // パスとコンポーネントのマッピング
          ...
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              if (response.status === _util__WEBPACK_IMPORTED_MODULE_1__.UNPROCESSABLE_ENTITY) {
                ...
                context.commit('errror/setCode', response.status, {
                  root: true
                });
              }
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              if (response.status === _util__WEBPACK_IMPORTED_MODULE_1__.UNPROCESSABLE_ENTITY) {
                ...
                // 他のモジュールのミューテーションにコミットする場合は、第三引数にroot:true
...
vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_4___default().use(vuex__WEBPACK_IMPORTED_MODULE_0__["default"]);
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            new (vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_5___default())({
              el: '#app',
